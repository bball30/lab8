...
public class StudyGroup implements Comparable<StudyGroup>, Serializable {
     ...
     */
    public StudyGroup(int id, String name, Coordinates coordinates, java.time.LocalDateTime creationDate,
                      long studentsCount, long shouldBeExpelled, int averageMark,
                      FormOfEducation formOfEducation, Person groupAdmin, User owner) {
        this.id = id;
        this.name = name;
    ...
    public boolean similar(StudyGroup studyGroup) {
        return Objects.equals(name, studyGroup.name) &&
                ...
                && Objects.equals(owner, studyGroup.owner);
    }

    @Override
    public int hashCode() {
        return Objects.hash(id, name, coordinates, creationDate, studentsCount, shouldBeExpelled, averageMark, formOfEducation, groupAdmin, owner);
    }
    ...
    public int compareTo(StudyGroup o) {
        if (studentsCount < o.studentsCount) {
            return -1;
        } else {
            if (studentsCount > o.studentsCount) {
                return 1;
    ...
    public Long getXx() {
        return groupAdmin.getLocation().getX();
    }

    public Float getYy() {
        return groupAdmin.getLocation().getY();
    }

    public double getZz() {
        return groupAdmin.getLocation().getZ();
    }
